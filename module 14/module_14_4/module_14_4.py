...
api = '7413507016:AAE_Xv6HoHJ3CjqYxtVlozPWLf2zuY2chJw'
bot = Bot(token=api)
...
product_kb1 = InlineKeyboardButton(
    text='Витамин B9', callback_data='product_buying')
product_kb2 = InlineKeyboardButton(
    text='Витамин D3', callback_data='product_buying')
product_kb3 = InlineKeyboardButton(
    text='Магний B6', callback_data='product_buying')
...
async def get_buying_list(call):
    ...
    photos = ['https://iimg.su/i/RxN9U', 'https://iimg.su/i/p0Z4b', 'https://iimg.su/i/R6cdY', 'https://iimg.su/i/nVcrs']
